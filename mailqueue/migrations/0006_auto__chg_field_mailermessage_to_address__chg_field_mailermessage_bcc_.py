...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mailqueue_mailermessage', 'to_address', self.gf('mailqueue.fields.EmailsListField')())

        # Changing field 'MailerMessage.bcc_address'
        db.alter_column(u'mailqueue_mailermessage', 'bcc_address', self.gf('mailqueue.fields.EmailsListField')())
    ...
    models = {
        ...
        u'mailqueue.mailermessage': {
            ...
            'bcc_address': ('mailqueue.fields.EmailsListField', [], {'blank': 'True'}),
            ...
            'to_address': ('mailqueue.fields.EmailsListField', [], {})
        }
    }
